...
const Contacet = () => {
    ...
    return (
        ...
        <section id='ContactId' className=" py-20 lg:py-[50px] overflow-hidden relative z-10">
            <h1 className="text-center text-4xl text-dark mb-20 font-semibold">_Contact</h1>
            ...
            <div className="container">
                <div className="flex lg:mx-20 flex-wrap lg:justify-around ">
                    ...
                    data-aos-duration="1500" className="w-full lg:w-1/2 xl:w-6/12 px-4">
                        <div className="max-w-[570px] border-stone-400  shadow-xl rounded-xl py-10  mb-12 lg:mb-0">
            ...
            ">
                            ...
                            <p className="text-base text-dark mx-10 leading-relaxed ">
                                ←! If you have any question, feel free to reach out to me . →
                            </p>
                            <div className='mx-10 mt-5 lg:flex items-center gap-2'>
                                
                                <div>
                                    <h1 className='text-dark font-semibold text-2xl'>_Email:</h1>
                    ...
                    <div data-aos="fade-left"
                        ...
                        <div className="shadow-2xl border-stone-400  relative rounded-lg p-8 sm:p-12 ">
                            <h1 className='text-3xl font-semibold mb-3 text-dark'>// Send a message</h1>

                            <form ref={form} onSubmit={sendEmail}>
                                <div className="mb-6">
                                    <label className='text-xl text-dark'>your-name</label>
                  ...
                  " />
                                ...
                                <div className="mb-6">
                                    <label className='text-xl text-dark'>your-email</label>
                  ...
                  px-[14px]
                  text-dark text-base
                  border border-stone-400 text-dark
                  outline-none
                  focus-visible:shadow-none
                  ...
                  " />
                                ...
                                <div className="mb-6">
                                    <label className='text-xl text-dark'>your-message</label>
