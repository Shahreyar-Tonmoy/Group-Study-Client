...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 px-20  pt-20 dark:bg-dark  lg:pt-[120px]">
        <div className="container">
          <div className=" flex flex-wrap">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold dark:text-dark tex ">
                  Follow Us On
                </h4>
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-semibold  dark:text-dark">
            {header}
          </h4>
