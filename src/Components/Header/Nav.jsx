...
const Nav = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="relative  pb-[110px] pt-[120px] dark:bg-dark lg:pt-[80px]">
          ...
          <div className=" flex mx-10 flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content flex-col justify-start items-start">
                ...
                Each member of the group brings their own understanding and knowledge of the subject. Through discussions and interactions, participants can benefit from the diverse perspectives and insights of their peers.
                </p>
