                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center">
                            <div className='flex flex-col justify-end'>
                                <h1 className="text-3xl text-center font-semibold">Click here for google drive pdf link</h1>

                                <a className='flex justify-center' href={pdfLink} target="_blank">
                                    <button className="flex mt-5 select-none items-center gap-2 rounded-lg py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-pink-500 transition-all hover:bg-pink-500/10 active:bg-pink-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-ripple-dark="true">
                                        Google Drive PDF
